...
public class UserController extends BaseController {
    ...
    public ResponseResult<Void> userRegister(
        ...
        if(role == 0){
            Customer customer = new Customer(nickname,password,sex,username,userAddress,email,0);
            ...
            HouseKeeper houseKeeper = new HouseKeeper(nickname,sex,username,password,email,0);
            userService.insertHouseKeeper(houseKeeper);
        }
